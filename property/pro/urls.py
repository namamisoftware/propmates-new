...
urlpatterns = [     
    ...
    path("property/residential/user/<int:user_id>/", get_R_properties_by_user), 
    path("property/commercial/user/<int:user_id>/", get_C_properties_by_user),      

    path("property/pg/user/<int:user_id>/", get_pg_properties_by_user),  
    path("property/holiday/user/<int:user_id>/", get_holiday_properties_by_user),
    path("property/agriculture/user/<int:user_id>/", get_agriculture_properties_by_user),
    path("property/business/user/<int:user_id>/", get_business_properties_by_user),


    # ==================================================================================

    # 🌾 Agriculture Property
    path("agriculture/soft-delete/<int:pk>/", soft_delete_agriculture_property),

    # 🏖 Holiday Property
    path("holiday/soft-delete/<int:pk>/", soft_delete_holiday_property),

    # 🏘 PG Property
    path("pg/soft-delete/<int:pk>/", soft_delete_pg_property),

    # 🏢 Business For Sale
    path("business/soft-delete/<int:pk>/", soft_delete_business_property),

    # 🏬 Commercial Property
    path("commercial/soft-delete/<int:pk>/", soft_delete_C_property),   

    # 🏠 Residential Property
    path("residential/soft-delete/<int:pk>/", soft_delete_R_property)
