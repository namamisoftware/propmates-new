...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let events = [
    {
      ...
      extendedProps: {
        label: "Holiday",
        description: "Celebrating the importance of Braille.",
      },
    },
    {
      id: "2",
      ...
      extendedProps: {
        label: "Meeting",
        description: "Raising awareness about leprosy.",
      },
    },
    {
      id: "3",
      ...
      extendedProps: {
        label: "Meeting",
        description: "General all-day event.",
      },
    },
    {
      id: "4",
      ...
      extendedProps: {
        label: "Birthday",
        description: "Celebrating a friend's birthday.",
      },
    },
    {
      id: "5",
      ...
      extendedProps: {
        label: "Deadline",
        description: "A repeating event over multiple days.",
      },
    },
    {
      id: "6",
      ...
      extendedProps: {
        label: "Holiday",
        description: "Weekend trip to relax and enjoy nature.",
      },
    },
    {
      id: "7",
    ...
    },
    {
      ...
      extendedProps: {
        label: "Deadline",
        description: "Final submission deadline for project.",
      },
    },
    {
      id: "15",
      ...
      extendedProps: {
        label: "Holiday",
        description: "Public national holiday.",
      },
    },
    {
      id: "16",
    ...
    },
    {
      ...
      extendedProps: {
        label: "Deadline",
        description: "Deadline for financial report submission.",
      },
    },
    {
      id: "18",
      ...
      extendedProps: {
        label: "Birthday",
        description: "A fun sports event for kids.",
      },
    },
    {
      id: "19",
      ...
      extendedProps: {
        label: "Holiday",
        description: "Outdoor camping with friends and family.",
      },
    },
    {
      id: "20",
  ...
  let calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    eventClick: function (info) {
      ...
      if (startEl)
        startEl.innerText = event.start
          ? event.start.toISOString().split("T")[0]
          : "N/A";
      if (endEl)
        endEl.innerText = event.end
          ? event.end.toISOString().split("T")[0]
          : "N/A";
      if (descEl)
        descEl.innerText = event.extendedProps.description || "No Description";
  ...
  document
    ...
    .addEventListener("submit", function (e) {
      ...
      let end =
        document.querySelectorAll('input[type="date"]')[1].value || start;
      let description = document.getElementById("description").value;
      let label =
        document.getElementById("form-select-01").selectedOptions[0].text;
  ...
  let externalEventsContainer = document.getElementById(
